...
public:
	...
	const double Evaluate (Function_EvaluateCallback pfnCallback, long userdata = 0);  // get result
	const double Evaluate (const std::string & program, Function_EvaluateCallback pfnCallback, long userdata = 0);  // get result
...
private:
	long						m_userdata; // by dummyz@126.com
