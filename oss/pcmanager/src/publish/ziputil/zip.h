...
HZIP CreateZip(const TCHAR *fn, const char *password, const char *comment);
HZIP CreateZip(void *buf,unsigned int len, const char *password, const char *comment);
HZIP CreateZipHandle(HANDLE h, const char *password, const char *comment);
...
ZRESULT ZipAdd(HZIP hz,const TCHAR *dstzn, const TCHAR *fn, IZipInfoCallback* callback);
ZRESULT ZipAdd(HZIP hz,const TCHAR *dstzn, void *src,unsigned int len, IZipInfoCallback* callback);
ZRESULT ZipAddHandle(HZIP hz,const TCHAR *dstzn, HANDLE h, IZipInfoCallback* callback);
ZRESULT ZipAddHandle(HZIP hz,const TCHAR *dstzn, HANDLE h, unsigned int len, IZipInfoCallback* callback);
ZRESULT ZipAddFolder(HZIP hz,const TCHAR *dstzn, IZipInfoCallback* callback);
