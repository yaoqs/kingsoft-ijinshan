...
ZRESULT UnzipItem(HZIP hz, int index, const TCHAR *fn, IZipInfoCallback* callback);
ZRESULT UnzipItem(HZIP hz, int index, void *z,unsigned int len, IZipInfoCallback* callback);
ZRESULT UnzipItemHandle(HZIP hz, int index, HANDLE h, IZipInfoCallback* callback);
