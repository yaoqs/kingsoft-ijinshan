...
#define SHP_DIV_ITEM_UNDERLINE_KEY		TEXT("underline")
...
public:
	...
	BEGIN_KEY_MAP()
		...
		ADD_INT_KEY( SHP_DIV_ITEM_UNDERLINE_KEY, m_i_underline)
...
protected:
	...
	void _init_font()
	{
		...
		if ( m_str_fontface.GetLength() > 0 || m_i_fontsize != INT_NO_SET || m_i_weight != INT_NO_SET )
		{
			...
			lf.lfUnderline = ( m_i_underline == 0 ? FALSE : TRUE );
