...
public:
	...
	BOOL SetTitleCanClickExpand(BOOL bExpand = FALSE);
...
protected:
	...
	LRESULT OnNcLButtonDown(WPARAM wParam, CPoint ptPos);
	LRESULT OnNcLButtonUp(WPARAM wParam, CPoint ptPos);
...
//	CSimpleArray<HBITMAP> m_arrImage;
	...
	BOOL m_bNeedReleaseCapture;
	BOOL m_bTitleCanClickExpand;
