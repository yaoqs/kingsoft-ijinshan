...
public:
	...
	// 增加新接口用来支持解析msg.ini中的模块升级 [11/3/2010 zhangbaoliang]
	virtual HRESULT ParseMsgIniModuleUpdate(LPCTSTR pszMsgIniFilePath) = 0;
};
...
//////////////////////////////////////////////////////////////////////////
//IUplive2 是为卫士开机升级单独提供的接口
//1.文件下载失败会通过onerror回调函数返回给UI,onerror中注意判读state = enumUpdStatusDownloadFiles

class __declspec(uuid("FCE6FE04-0237-4891-B612-28D91E0A9E56"))
IUplive2 : public IUplive
{
public:
	// 新增接口用来下载指定的URL来更新 [12/22/2010 zhangbaoliang]
	virtual HRESULT ForceUpdateSpecialFile(LPCTSTR pszUpdateUrl, LPCTSTR pszDownloadFileName, DWORD dwUpdateType) = 0;
};
